...
molecules_md17 = ['aspirin', 'ethanol', 'toluene', 'benzene', 'salicylic_acid', 'toluene', 'uracil']

molecules_md22 = ['DHA', 'ac_Ala3_NHMe', 'buckyball_catcher', 'stachyose', 'AT_AT_CG_CG', 'AT_AT', 'double_walled_nanotube']
