...
config_yml="/global/homes/s/sanjeevr/implicit-md/configs/water/train.yml"
command_train="python $script --config-yml $config_yml --model=$1 --rdf_loss_weight=$2 --vacf_loss_weight=$3 \
               --energy_force_loss_weight=$4 --only_learn_if_unstable_threshold_reached=$5 --exp_name=$6"
srun $command_train
