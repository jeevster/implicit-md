...
command_train="python $script --config-yml $config_yml"
# command_train="python $script --config-yml $config_yml --model=nequip --molecule=$1 --size=10percent --rdf_loss_weight=$2 --vacf_loss_weight=$3 --minibatch_size=8 \
